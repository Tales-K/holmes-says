...
- **Summarization:** Summarize transcriptions or history items using OpenAI GPT-4.1.
...
4. **Summarize:** Click to summarize the transcription or any history item using GPT-4.1.
